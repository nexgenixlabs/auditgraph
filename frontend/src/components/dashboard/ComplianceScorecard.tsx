...
const controlDrillDown: Record<string, string> = {
  ...
  'CC6.6': '/identities?ca_coverage=not_covered',
  'CC7.1': '/identities?activity_status=stale',
  'CC7.2': '/identities?activity_status=dormant&privilege_tier=0,1',
  'CC8.1': '/identities?risk_level=critical,high',
  'CC8.2': '/identities?credential_status=expired',
  // HIPAA
  ...
  '§164.308(a)(4)': '/identities?activity_status=stale&hasRoles=true',
  '§164.308(a)(5)': '/identities?ca_coverage=not_covered',
  '§164.308(a)(8)': '/identities?activity_status=stale',
  '§164.312(b)': '/identities?risk_level=high',
  '§164.312(c)': '/identities?risk_level=critical,high',
  '§164.312(e)': '/identities?credential_status=expired',
  // PCI-DSS
  '7.1': '/identities?privilege_tier=0',
  '7.2.1': '/identities?credential_status=expired',
  '7.2.2': '/identities?risk_level=critical,high',
  '8.2.1': '/identities?identity_category=human_user&risk_level=high',
  '8.3': '/identities?credential_status=expired',
  '8.3.6': '/identities?ca_coverage=not_covered',
  '8.5': '/identities?identity_category=human_user&risk_level=high',
  '8.6': '/identities?owner_status=unowned&identity_category=service_principal',
  '10.1': '/identities?activity_status=stale',
  '10.2': '/identities?activity_status=stale&hasRoles=true',
  // NIST 800-53
  'AC-2': '/identities?activity_status=stale',
  'AC-3': '/identities?risk_level=critical,high',
  'AC-5': '/identities?identity_category=human_user&risk_level=high',
  'AC-6': '/identities?privilege_tier=0',
  'AC-17': '/identities?ca_coverage=not_covered',
  'AU-6': '/identities?activity_status=stale&hasRoles=true',
  'IA-2': '/identities?ca_coverage=not_covered',
  'IA-4': '/identities?activity_status=stale',
  'IA-5': '/identities?credential_status=expired',
  'IA-8': '/identities?identity_category=guest&ca_coverage=not_covered',
  'SI-4': '/identities?activity_status=stale&hasRoles=true',
  'PM-10': '/identities?identity_category=service_principal&owner_status=unowned',
  // CIS Azure
  '1.1': '/identities?privilege_tier=0',
  '1.2': '/identities?activity_status=stale',
  '1.3': '/identities?ca_coverage=not_covered',
  '1.4': '/identities?identity_category=guest',
  '1.5': '/identities?identity_category=service_principal&owner_status=unowned',
  // ISO 27001
  'A.5.15': '/identities?privilege_tier=0',
  'A.5.16': '/identities?activity_status=stale',
  'A.5.17': '/identities?credential_status=expired',
  'A.8.2': '/identities?risk_level=critical,high',
  'A.8.5': '/identities?ca_coverage=not_covered',
};
