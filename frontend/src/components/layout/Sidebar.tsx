    ...
    const groups: NavGroup[] = [
      {
        label: 'Overview',
        items: [
          { to: '/', label: 'Executive Summary', matchExact: true, icon: overviewIcon },
          { to: '/dashboard', label: 'Risk Monitoring', icon: dashboardIcon },
        ],
      },
      {
        label: 'Public Cloud',
      ...
      },
      {
        ...
        items: [
          ...
          { to: '/rbac-hygiene', label: 'RBAC Hygiene', icon: <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg> },
          { to: '/service-accounts', label: 'Identity Governance', icon: spnIcon },
          { to: '/identity-correlation', label: 'Account Correlation', icon: <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1" /></svg> },
      ...
      },
      {
        ...
        items: [
          ...
          { to: '/invoices', label: 'Invoices', icon: <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg> },
        ],
      },
      {
