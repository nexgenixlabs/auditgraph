    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900">
        <div className="text-center max-w-md px-4">
          ...
          <h1 className="text-xl font-bold text-gray-900 dark:text-white mb-2">SSO Login Failed</h1>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900">
      <div className="text-center">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400">Completing SSO login...</p>
      </div>
    </div>
  );
}
