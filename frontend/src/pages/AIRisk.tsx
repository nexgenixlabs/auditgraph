...
export default function AIRisk() {
  ...
  return (
    <div className="p-6 max-w-[1400px] mx-auto space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-white">AI Risk</h1>
        <p className="text-sm text-slate-400 mt-1">
          Attack scenarios across {s.total_agents} AI agent{s.total_agents === 1 ? '' : 's'} —
          derived from architecture, mapped to MITRE ATT&CK
        </p>
      </div>
