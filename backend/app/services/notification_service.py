...
class NotificationService:
    ...
    def notify_discovery_completed(self, run_id: int, summary: dict):
    ...
    def notify_new_identities(self, run_id: int, new_identities: list):
    ...
    def notify_removed_identities(self, run_id: int, removed: list):
    ...
    def notify_risk_escalations(self, run_id: int, escalations: list):
    ...
    def notify_permission_changes(self, run_id: int, changes: list):
    ...
    def notify_credential_changes(self, run_id: int, changes: list):
