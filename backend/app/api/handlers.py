        ...
        identities.append(
            {
                ...
                "credential_count": int(row[4]) if row[4] else 0,
                "next_expiry": row[5].isoformat() if row[5] else None,
                "credential_risk": row[6] or "unknown",
                "credential_status": row[7] or "Unknown",
                "credential_expiration": row[8].isoformat() if row[8] else None,
                "created_datetime": row[9].isoformat() if row[9] else None,
                "activity_status": row[10] or "unknown",
                "role_count": int(row[11]) if row[11] else 0,
            }
        )
