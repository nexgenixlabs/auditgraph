  ...
  const NAV = [
    ...
    },
    {
      ...
      pages: [
        ...
        { slug: 'breach-cost-methodology', title: 'Breach Cost Methodology' },
      ],
    },
    {
      section: 'Screen Walkthroughs',
      icon: '🧭',
      color: '#a78bfa',
      pages: [
        { slug: 'screen-executive-posture',   title: 'Executive Posture' },
        ...
        { slug: 'screen-threat-connectors',   title: 'Threat Connectors' },
        { slug: 'screen-ai-findings',         title: 'AI Findings' },
        { slug: 'screen-peer-benchmarking',   title: 'Peer Benchmarking' },
      ],
    },
    {
      section: 'Operations',
